...
// gebruik functie is NaN om te controleren of een waarde geconverteerd kan worden naar een numerieke waarde
//if (isNaN(getal) == true) {
// korter:
if (isNaN(getal)) { 
...
console.log("5/0 = %s", 5 / 0); // infinity
console.log("0/0 = %d", 0 / 0); // NaN
